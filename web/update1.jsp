				...
				<div class="col-md-6 order-form-grids">
					...
					<div class="order-form-grid  wow fadeInLeft" data-wow-delay="0.4s">
						<h2>Food Details:</h2>
                                                ...
                                                <input name="fid1"  type="text" class="text" value="<%= fiid%>" readonly=""><br>
					<input name="foodname1"  type="text" class="text" value="<%= foodname%>"  readonly=""><br>
                                        <input name="foodprice1"  type="text" class="text" value="<%= foodprice%>"  required><br>
